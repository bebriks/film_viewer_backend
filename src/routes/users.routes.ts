 ...
 *              $ref: '#/components/schemas/ErrorResponse'
 */
userRouter.get('/favorites', isAuthenticated, getFavorites);
 ...
 *              $ref: '#/components/schemas/ErrorResponse'
 */
userRouter.delete('/favorites/:favoriteId', isAuthenticated, removeFromFavorites);
 ...
 *              $ref: '#/components/schemas/ErrorResponse'
 */
userRouter.post('/comments', isAuthenticated, createComment);
 ...
 *              $ref: '#/components/schemas/ErrorResponse'
 */
userRouter.get('/movies/:movieId/comments', getMovieComments);
 ...
 *              $ref: '#/components/schemas/ErrorResponse'
 */
userRouter.delete('/comments/:commentId', isAuthenticated, deleteComment);
